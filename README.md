...
This project is a simple resume/personal website for Sebastian Wicker created by Sofia Cole.

To launch the website:

1) Close the repository from https://github.com/hyperionvii

2) Npm install

3) Npm start

Additional Resources regarding 'Create React App' are located below.
